...
public class TextEditor extends JPanel implements LocaleChangeListener{
	 ...
	 * @param default Path
	 */
	public TextEditor(String hint, Locale locale, String defPath) {
		defaultPath = defPath;
		this.locale = locale;
		this.hint = hint;
		init();
	...
	public TextEditor(String hint, Locale locale){
	...
	private void init(){
		...
		PromptSupport.init(hint, Color.GRAY, null, textArea);
		...
		mntmOpen.setIcon(new ImageIcon(TextEditor.class.getResource("/res/toolbaricons/black/png/folder_open_icon&16.png")));
		...
		mntmSave.setIcon(new ImageIcon(TextEditor.class.getResource("/res/toolbaricons/black/png/save_icon&16.png")));
		...
		mntmSaveAs.setIcon(new ImageIcon(TextEditor.class.getResource("/res/toolbaricons/black/png/save_icon&16.png")));
		...
		mntmUndo.setIcon(new ImageIcon(TextEditor.class.getResource("/res/toolbaricons/black/png/undo_icon&16.png")));
		...
		mntmRedo.setIcon(new ImageIcon(TextEditor.class.getResource("/res/toolbaricons/black/png/redo_icon&16.png")));
		...
		mntmCut.setIcon(new ImageIcon(TextEditor.class.getResource("/res/toolbaricons/black/png/clipboard_cut_icon&16.png")));
		mntmCut.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, InputEvent.CTRL_MASK));
		mnEdit.add(mntmCut);
		
		mntmCopy = new JMenuItem(new DefaultEditorKit.CopyAction());
		mntmCopy.setText(lang.getString("copy"));
		mntmCopy.setIcon(new ImageIcon(TextEditor.class.getResource("/res/toolbaricons/black/png/clipboard_copy_icon&16.png")));
		mntmCopy.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, InputEvent.CTRL_MASK));
		mnEdit.add(mntmCopy);
		
		mntmPaste = new JMenuItem(new DefaultEditorKit.PasteAction());
		mntmPaste.setText(lang.getString("paste"));
		mntmPaste.setIcon(new ImageIcon(TextEditor.class.getResource("/res/toolbaricons/black/png/clipboard_past_icon&16.png")));
